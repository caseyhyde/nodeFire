db.users.insert(
   [
    ...
    { email: 'hyde.casey@gmail.com', clearanceLevel: 4 }, // Your Google Email added here
    { email: 'prime.casey.hyde@gmail.com', clearanceLevel: 2 }, // Your Other Google Email added here
